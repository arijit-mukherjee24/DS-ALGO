...
public class BooleanParenthesizationProblem {
	...
	/*
	 * Approach 2: We can also use the recursive approach (Top Down dp), this
	 * approach uses memoization
	 */

	
	public static int countWays(int N, String S) {
		// This can also be solved using HashMap as suggested by Aditya Verma
