...
// Leetcode 1778. Shortest Path in a Hidden Grid (Subscribed)
// https://leetcode.ca/2021-04-30-1778-Shortest-Path-in-a-Hidden-Grid/

// This is the GridMaster's API interface.
// You should not implement it, or speculate about its implementation
 class GridMaster {
     boolean canMove(char direction) {
		return false; // Added impl for removing the error in the code
	}
     void move(char direction) {
    	// Added impl for removing the error in the code
	}
     boolean isTarget() {
		return false;    // Added impl for removing the error in the code
	}
