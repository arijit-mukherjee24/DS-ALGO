...
class MinimumDifferenceElementInSortedArray {
	...
	private static int binarySearchMinDifference(int[] a, int target) {
		...
		/*
		 * At the end of the while loop, a[start] is the ceiling of target (Smallest
		 * number greater than target), and a[end] is the floor of target (Largest
		 * number smaller than target).
		 * 
