...
// Pick Toys :  Longest Substring with (K=2) unique characters
// Callicoder Sliding Window
// Youtube - Sliding Window Series AV
...
class LongestSubstringWithKUniqueCharacters {
	...
	public static void main(String[] args) {
		...
		System.out.printf("Longest substring with %d unique characters = %d%n", k,
